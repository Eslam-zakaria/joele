...
<html lang="en">
    <head>
        ...
        <!-- Favicon icon -->
        <link rel="shortcut icon" href="{{ $settings['website_icon'] ?? '' }}" type="image/x-icon">
        <link rel="icon" href="{{ $settings['website_icon'] ?? '' }}" type="image/x-icon">
            ...
            ***********************************-->
            <div class="nav-header">
                <a href="{{ route('admin.dashboard.index') }}" class="brand-logo">
                    <img class="logo-abbr" src="{{ $settings['website_logo'] ?? asset('frontend/images/logo.svg') }}" alt="">
                </a>
