...
class DoctorUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'category_id' => ['required', 'numeric', 'exists:categories,id', new CategoryActiveRule('doctors')],
            ...
            'en.slug' => ['required_if:language,1,3', 'unique:blog_translations,slug', 'max:255'],
            'ar.slug' => ['required_if:language,2,3', 'unique:blog_translations,slug', 'max:255'],
