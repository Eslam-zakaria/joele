...
@section('title', "Edit a Doctor ( $doctor->name )")
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.doctors.update', $doctor->id) }}">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 @error('image') has-danger @enderror">
                                        ...
                                        <input type="file"
                                               ...
                                               class="dropify"
                                               data-height="200"
                                               data-default-file="{{ $doctor->doctor_image }}"/>
                                ...
                                <div class="row">
                                    <div class="form-group col-md-4 @error('title_header_option') has-danger @enderror">
                                        ...
                                        <select class="custom-select form-control" name="title_header_option">
                                            <option value="h1" {{ $doctor->title_header_option == 'h1' ? 'selected' : '' }}>h1</option>
                                            <option value="h2" {{ $doctor->title_header_option == 'h2' ? 'selected' : '' }}>h2</option>
                                            <option value="h3" {{ $doctor->title_header_option == 'h3' ? 'selected' : '' }}>h3</option>
                                            <option value="h4" {{ $doctor->title_header_option == 'h4' ? 'selected' : '' }}>h4</option>
                                            <option value="h5" {{ $doctor->title_header_option == 'h5' ? 'selected' : '' }}>h5</option>
                                            <option value="h6" {{ $doctor->title_header_option == 'h6' ? 'selected' : '' }}>h6</option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-4 @error('specialization_title_header_option') has-danger @enderror">
                                        ...
                                        <select class="custom-select form-control" name="specialization_title_header_option">
                                            <option value="h1" {{ $doctor->specialization_title_header_option == 'h1' ? 'selected' : '' }}>h1</option>
                                            <option value="h2" {{ $doctor->specialization_title_header_option == 'h2' ? 'selected' : '' }}>h2</option>
                                            <option value="h3" {{ $doctor->specialization_title_header_option == 'h3' ? 'selected' : '' }}>h3</option>
                                            <option value="h4" {{ $doctor->specialization_title_header_option == 'h4' ? 'selected' : '' }}>h4</option>
                                            <option value="h5" {{ $doctor->specialization_title_header_option == 'h5' ? 'selected' : '' }}>h5</option>
                                            <option value="h6" {{ $doctor->specialization_title_header_option == 'h6' ? 'selected' : '' }}>h6</option>
                                        </select>
                                    ...
                                    <div class="form-group col-md-4 @error('language') has-danger @enderror">
                                        ...
                                        <select class="custom-select form-control" id="language_input" disabled>
                                            ...
                                            @foreach(config('translatable.locales') as $key => $locale)
                                                @php(++$key)
                                                <option value="{{ $key }}" {{ $doctor->language == $key ? 'selected' : '' }}>
                                                    @lang("system.$locale")
                                                </option>
                                            @endforeach
                                            <option value="3" {{ $doctor->language == 3 ? 'selected' : '' }}>All</option>
                                        </select>
                                        <input type="hidden" name="language" value="{{ $doctor->language }}" />
                                    </div>
                                </div>
                                                        ...
                                                        <div class="pt-4 row">
                                                            <div class="form-group bmd-form-group col-md-6 @error("$locale.name") has-danger @enderror">
                                                                ...
                                                                <input type="text"
                                                                       ...
                                                                       value="{{ $doctor->translate($locale)->name ?? '' }}"
                                                            ...
                                                            <div class="form-group bmd-form-group col-md-6 @error("$locale.slug") has-danger @enderror">
                                                                ...
                                                                <input type="text"
                                                                       ...
                                                                       value="{{ $doctor->translate($locale)->slug ?? '' }}"
                                                                       class="form-control input_{{ $locale }}" />
                                                            ...
                                                            <div class="form-group bmd-form-group col-md-12 @error("$locale.experience_years") has-danger @enderror">
                                                                <label for="experience_years_input"> Experience years {{ $locale }} <span class="text-danger">*</span></label>

                                                                <input type="text"
                                                                       id="experience_years_input"
                                                                       name="{{ $locale }}[experience_years]"
                                                                       placeholder="Enter experience years"
                                                                       value="{{ $doctor->translate($locale)->experience_years ?? '' }}"
                                                                       class="form-control input_{{ $locale }}" />
                                                            ...
                                                            <div class="form-group bmd-form-group col-md-12 @error("$locale.description") has-danger @enderror">
                                                                ...
                                                                <textarea
                                                                    ...
                                                                    rows="10">{{ $doctor->translate($locale)->description ?? '' }}</textarea>
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text"
                                                                       ...
                                                                       value="{{ $doctor->translate($locale)->meta_title ?? '' }}"
                                                                       class="form-control input_{{ $locale }}" />
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text"
                                                                       ...
                                                                       value="{{ $doctor->translate($locale)->canonical ?? '' }}"
                                                                       class="form-control input_{{ $locale }}" />
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <textarea id="meta_description"
                                                                          ...
                                                                          class="form-control summernote_content input_{{ $locale }}"
                                                                          rows="10">{{ $doctor->translate($locale)->meta_description ?? '' }}</textarea>
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <textarea id="meta_keywords"
                                                                          ...
                                                                          class="form-control input_{{ $locale }}"
                                                                          rows="5">{{ $doctor->translate($locale)->meta_keywords ?? '' }}</textarea>
                                                            ...
                                                            <div class="form-group col-md-12">
                                                                ...
                                                                <input type="text"
                                                                       ...
                                                                       placeholder="Enter title"
                                                                       value="{{ $doctor->translate($locale)->alt_image ?? '' }}"
                                                                       class="form-control input_{{ $locale }}" />
                                                            ...
                                                            <div class="form-group col-md-12 mt-5" id="doctor_experience_{{ $locale }}">
                                                                ...
                                                                @if( $doctor->experience->count() )
                                                                    @foreach($doctor->experience as $key => $experienceData)
                                                                        <div class="row doctor_experience_row_{{ $locale }}">
                                                                            <div class="form-group col-md-6">
                                                                                ...
                                                                                <input type="text"
                                                                                       ...
                                                                                       value="{{ $experienceData->translate($locale)->company_name ?? '' }}"
                                                                                       class="form-control input_{{ $locale }}"  />
                                                                            </div>
                                                                            ...
                                                                            <div class="form-group col-md-6">
                                                                                ...
                                                                                <input type="text"
                                                                                       ...
                                                                                       value="{{ $experienceData->translate($locale)->specialization ?? '' }}"
                                                                                       class="form-control input_{{ $locale }}" />
                                                                            </div>
                                                                        </div>
                                                                    @endforeach
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <select name="category_id" id="category_select_input" class="form-control">
                                                    ...
                                                    @foreach($categories as $category)
                                                        <option value="{{ $category->id }}" data-services="{{ $category->services }}" data-specialization="{{ $category->specialization }}" {{ $doctor->category_id ==  $category->id ? 'selected' : '' }}>
                                                            {{ $category->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                            ...
                                            <div class="col-md-12 form-group">
                                                ...
                                                <select class="form-control js-example-basic-multiple" id="branches_select_input" name="branches[]" multiple="multiple">
                                                    @foreach($branches as $branch)
                                                        <option value="{{ $branch->id }}" {{ in_array($branch->id, $doctor->branches->pluck('id')->toArray() ?? []) ? 'selected' : '' }}>
                                                            {{ $branch->name }}
                                                        </option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ $doctor->socialMedia->instagram ?? '' }}"
                                                       class="form-control" />
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ $doctor->socialMedia->youtube ?? '' }}"
                                                       class="form-control" />
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ $doctor->socialMedia->snapchat ?? '' }}"
                                                       class="form-control" />
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       placeholder="Enter whats app link"
                                                       value="{{ $doctor->socialMedia->whats_app ?? '' }}"
                                                       class="form-control" />
                                            ...
                                            <div class="col-md-6 form-group">
                                                ...
                                                <input type="text"
                                                       ...
                                                       value="{{ $doctor->socialMedia->email ?? '' }}"
                                                       class="form-control" />
        ...
        $(document).ready(function () {
            ...
            if( services != undefined ){
                $.each(services, function (index, value){
                    ...
                    if( jQuery.inArray(value.id, {{ json_encode($doctor->services->pluck('id')->toArray()) }}) !== -1 ){
                        $('#services_select_input').append('<option value="'+ value.id +'" selected>'+ value.name +'</option>');
                    } else {
            ...
            if( specialization != undefined ){
                $.each(specialization, function (index, value){
                    if( jQuery.inArray(value.id, {{ json_encode($doctor->specializations->pluck('id')->toArray()) }}) !== -1 ){
                        $('#specializations_select_input').append('<option value="'+ value.id +'" selected>'+ value.name +'</option>');
                    } else {
            ...
            let element_{{ $locale }} =
                '<div class="row doctor_experience_row_{{ $locale }}"> \n'+
                    '<div class="form-group col-md-6"> \n'+
                        ...
                        '<input type="text" id="company_name_input" name="experience['+ row_length_{{ $locale }} +'][{{ $locale }}][company_name]" placeholder="Enter company name" class="form-control" /> \n'+
                    '</div> \n'+
                    '<div class="form-group col-md-6"> \n'+
                        '<label for="specialization_input"> Specialization {{ $locale }} <span class="text-danger">*</span> </label> \n'+
                        '<input type="text" id="specialization_input" name="experience['+ row_length_{{ $locale }} +'][{{ $locale }}][specialization]" placeholder="Enter Specialization" class="form-control" /> \n'+
                    '</div> \n'+
                '</div>';
