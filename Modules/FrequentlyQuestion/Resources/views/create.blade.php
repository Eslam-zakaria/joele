...
@section('title', 'Create a new Frequently Asked Questions')
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.frequently-questions.store') }}">
                                @method('POST')
                                @csrf

                                <div class="form-row" style="margin-bottom:  10px">
                                    <div class="form-group col-md-8 @error('category_id') has-danger @enderror">
                                                    ...
                                                    <div class="pt-4 row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input name="{{ $locale }}[question]"
                                                                   ...
                                                                   placeholder="@lang("system.$locale") Question"
