            ...
            <div class="row">
                ...
                <div class="col-md-1 col-sm-3 mb-1">
                    <div class="input-group  d-xl-inline-flex">
                        <a class="btn btn-success" :href="route('admin.frequently-questions.create')" title="New">
                                ...
                                <tr v-for="question in questions.data" :id="'element_row_' + question.id">
                                    ...
                                    <td>
                                        <button type="button"
                                                ...
                                                :data-url="route('api.frequently-question.status', {frequently_question: question.id})"
                                        ...
                                        <button type="button"
                                                ...
                                                :data-url="route('api.frequently-question.destroy', {frequently_question: question.id})"
                                        ...
                                        <a :href="route('admin.frequently-questions.edit', {frequently_question: question.id})" class="light sharp btn btn-info btn-icon mr-1">
                                            <i class="fa fa-pencil-square-o"></i>
                                        </a>

                                        <a :href="route('admin.frequently-question-copy', {frequently_question: question.id})" class="light sharp btn btn-warning btn-icon mr-1">
...
<script>
export default {
    name: 'frequently-questions-list',
    data: function () {
        return {
            'q' : '',
    ...
    methods: {
        fetchQuestions(page = 1) {
            this.page = page;
            axios
                .get(route('api.frequently-questions.index', {
                    page: page,
                    q : this.q,
                    sort : this.sort.id,
