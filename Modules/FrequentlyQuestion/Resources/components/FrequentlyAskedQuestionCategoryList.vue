            ...
            <div class="row">
                ...
                <div class="col-md-1 col-sm-3 mb-1">
                    <div class="input-group  d-xl-inline-flex">
                        <a class="btn btn-success" :href="route('admin.questions-category.create')" title="New">
                            ...
                            <tr v-for="category in categories.data" :id="'element_row_' + category.id">
                                ...
                                <td>
                                    <button type="button"
                                            ...
                                            :data-url="route('api.questions-category.status', {question_category: category.id})"
                                    ...
                                    <button type="button"
                                            ...
                                            :data-url="route('api.questions-category.destroy', {question_category: category.id})"
                                    ...
                                    <a :href="route('admin.questions-category.edit', {questions_category: category.id})" class="light sharp btn btn-info btn-icon mr-1">
...
<script>
export default {
    name: 'frequently-asked-question-category-list',
    data: function () {
        return {
            'q' : '',
    ...
    methods: {
        fetchCategories(page = 1) {
            this.page = page;
            axios
                .get(route('api.questions-category.index', {
                    page: page,
                    q : this.q,
                    sort : this.sort.id,
