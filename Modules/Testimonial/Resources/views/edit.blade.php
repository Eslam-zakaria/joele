...
@section('title', "Edit a Testimonial ( $testimonial->name )")
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.testimonials.update', ['testimonial' => $testimonial->id]) }}">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="form-row " style="margin-bottom:  10px">
                                    ...
                                    <div class="form-group col-md-6 @error('image') has-danger @enderror">
                                        ...
                                        <input type="file"
                                               ...
                                               class="dropify"
                                               data-height="200"
                                               data-default-file="{{ $testimonial->testimonial_image }}"/>
                                                    ...
                                                    <div class="pt-4">
                                                        ...
                                                        <div class="form-group bmd-form-group col-md-12 @error("$locale.description") has-danger @enderror">
                                                            ...
                                                            <textarea id="brif_id"
                                                                      ...
                                                                      class="form-control"
                                                                      rows="10">{{ $testimonial->translate($locale)->description }}</textarea>
                                ...
                                <div class="form-row" style="margin-bottom:  10px">
                                    <div class="form-group col-md-12 @error('rating') has-danger @enderror">
                                        <label for="select_page_id"> Rating <span class="text-danger">*</span></label>

                                        <div>
                                            @for($ratingRow = 1 ; $ratingRow <= 5 ; $ratingRow++)
                                                <div class="form-check form-check-inline">

                                                    <input class="form-check-input"
                                                           type="radio"
                                                           name="rating"
                                                           id="rating_{{ $ratingRow }}"
                                                           value="{{ $ratingRow }}" {{ $testimonial->rating == $ratingRow ? 'checked' : ''  }} />

                                                    <label class="form-check-label" for="rating_{{ $ratingRow }}">
                                                        @for($stars = 1 ; $stars <= $ratingRow ; $stars++ )
