                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.categories.update', $category->id) }}">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="form-row " style="margin-bottom:  10px">
                                    ...
                                    <div class="form-group col-md-4 @error('image') has-danger @enderror">
                                        ...
                                        <input type="file"
                                               ...
                                               class="dropify"
                                               data-height="200"
                                               data-default-file="{{ $category->category_image }}"/>
                                                    ...
                                                    <div class="row pt-4">
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea id="input_description"
                                                                      ...
                                                                      class="form-control"
                                                                      rows="10">{{ $category->translate($locale)->description }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input name="{{ $locale }}[alt_image]"
                                                                   value="{{ $category->translate($locale)->alt_image }}"
                                                                   id="alt_image_input"
                                                                   class="form-control" />
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea id="input_meta_description"
                                                                      ...
                                                                      class="form-control"
                                                                      rows="10">{{ $category->translate($locale)->meta_description }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <textarea id="input_meta_keywords"
                                                                      ...
                                                                      class="form-control"
                                                                      rows="10">{{ $category->translate($locale)->meta_keywords }}</textarea>
                                                        ...
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input name="{{ $locale }}[canonical]"
                                                                   value="{{ $category->translate($locale)->canonical }}"
                                                                   id="canonical_input"
                                                                   class="form-control" />
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="js-example-basic-multiple" id="select_display_in_input" name="display_in[]" multiple="multiple">
                                            @foreach($categoriesRelation as $relation)
                                                <option value="{{ $relation }}" {{ $category->displayInData && in_array($relation, $category->displayInData) ? 'selected' : '' }}>{{ $relation }}</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control" id="select_grid_option_input" name="service_items_per_row">
                                            ...
                                            @foreach($gridOptions as $gridOptionKey => $gridOption)
                                                <option value="{{ $gridOptionKey }}" {{ $category->service_items_per_row == $gridOptionKey ? 'selected' : '' }}>
                                                    {{ $gridOption['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
