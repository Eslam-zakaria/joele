                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.blogs.update', $blog->id) }}">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 @error('image') has-danger @enderror">
                                        ...
                                        <input type="file"
                                               ...
                                               class="dropify"
                                               data-height="200"
                                               data-default-file="{{ $blog->blog_image }}" />
                                ...
                                <div class="row">
                                    ...
                                    <div class="form-group col-md-4 @error('locale') has-danger @enderror">
                                        ...
                                        <select class="custom-select form-control" id="locale_input" name="locale">
                                            @foreach(config('translatable.locales') as $locale)
                                                <option value="{{ $locale }}" {{ $blog->locale == $locale ? 'selected' : '' }}>@lang("system.$locale")</option>
                                            @endforeach
                                        </select>
                                    ...
                                    <div class="col-md-12 form-group">
                                        ...
                                        <select class="form-control js-example-basic-multiple" id="parents_select_input" name="parent_id">
                                            <option value="">-- Select --</option>
                                            @if(!empty($Allblogs))
                                                @foreach($Allblogs as $blogs)
                                                    <option value="{{ $blogs->id }}" {{ $blog->parent_id == $blogs->id ? 'selected' : '' }}>{{ $blogs->title }}</option>
                                                @endforeach
                                            @endif
                                        </select>
                                        @error("parent_id")
                                        ...
                                        <div class="tab-content">
                                            <div class="pt-4 row">
                                                <div class="form-group bmd-form-group col-md-9 @error("title") has-danger @enderror">
                                                    <label for="name_id"> Name <span class="text-danger">*</span></label>
                                                ...
                                                <div class="form-group col-md-3">
                                                    ...
                                                    <select class="custom-select form-control" name="title_header_optional">
                                                        <option value="">-- select --</option>
                                                        <option value="h1" {{ $blog->title_header_optional == 'h1' ? 'selected' : '' }}>h1</option>
                                                        <option value="h2" {{ $blog->title_header_optional == 'h2' ? 'selected' : '' }}>h2</option>
                                                        <option value="h3" {{ $blog->title_header_optional == 'h3' ? 'selected' : '' }}>h3</option>
                                                        <option value="h4" {{ $blog->title_header_optional == 'h4' ? 'selected' : '' }}>h4</option>
                                                        <option value="h5" {{ $blog->title_header_optional == 'h5' ? 'selected' : '' }}>h5</option>
                                                        <option value="h6" {{ $blog->title_header_optional == 'h6' ? 'selected' : '' }}>h6</option>
                                                    </select>
                                            ...
                                            <div class="pt-4 row">
                                                                ...
                                                                <div class="row border p-3 mt-3 blog_section blog_row_{{ $key }}">
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="color"
                                                                                   class="form-control"
                                                                                   value="{{ $sectionRow->section_color ?? '#ffffff' }}"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <input type="color"
                                                                                   class="form-control"
                                                                                   value="{{ $sectionRow->color_border ?? '#ffffff' }}"
                                                                    ...
                                                                    <div class="col-md-4">
                                                                        <div class="form-group">
                                                                            <label for="content_name"> Sorting </label>

                                                                            <input type="number"
                                                                                   class="form-control"
                                                                                   value="{{ $sectionRow->sorting ?? '' }}"
                                                                                   min="1"
                                                                    ...
                                                                    <div class="form-group col-md-4">
                                                                        ...
                                                                        <select class="custom-select form-control" name="sections[{{ $key }}][h_optionl]">
                                                                            <option value="h1" {{ $sectionRow->h_optionl == 'h1' ? 'selected' : '' }}>h1</option>
                                                                            <option value="h2" {{ $sectionRow->h_optionl == 'h2' ? 'selected' : '' }}>h2</option>
                                                                            <option value="h3" {{ $sectionRow->h_optionl == 'h3' ? 'selected' : '' }}>h3</option>
                                                                            <option value="h4" {{ $sectionRow->h_optionl == 'h4' ? 'selected' : '' }}>h4</option>
                                                                            <option value="h5" {{ $sectionRow->h_optionl == 'h5' ? 'selected' : '' }}>h5</option>
                                                                            <option value="h6" {{ $sectionRow->h_optionl == 'h6' ? 'selected' : '' }}>h6</option>
                                                                        </select>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <textarea id="content_input"
                                                                                      ...
                                                                                      rows="10">{{ $sectionRow->content ?? ''}}</textarea>
                                                ...
                                                <div class="col-md-12 mt-3">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea id="meta_description" name="meta_description" class="form-control" rows="10">{{ $blog->meta_description ?? ''}}</textarea>
                                                        ...
                                                        <div class="form-group col-md-6">
                                                            ...
                                                            <textarea id="meta_keywords" name="meta_keywords" class="form-control" rows="10">{{ $blog->meta_keywords ?? ''}}</textarea>
                                                ...
                                                <div class="form-group col-md-12 mt-3" id="doctor_experience">
                                                    ...
                                                    @if( $getQuestions )
                                                        @foreach($getQuestions as $key => $questionsData)
                                                            <div class="row doctor_experience_row mb-4" style="background-color: #f0f1f5d6;">
                                                                <input type="hidden" name="experienceEdit[{{ $key }}][id]" value="{{ $questionsData->id }}" class="form-control">

                                                                <div class="form-group col-md-12">
                                                                    <a onclick="return confirm('Are You Sure You Want To Delete This Record ?')" href="{{ route('admin.blog-faq.delete',['question' => $questionsData->id]) }}" class="btn btn-danger btn-flat btn-icon-only mt-2" style="float: right;"> <i class="fa fa-trash-o"></i> </a>
                                                                </div>
                                                                <div class="form-group col-md-12">
                                                                    <label for="company_name_input"> Question <span class="text-danger">*</span></label>
                                                                    <input type="text" id="question_input" name="experienceEdit[{{ $key }}][question]" value="{{ $questionsData->question }}" placeholder="Enter Question title" class="form-control" />
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    ...
                                                                    <textarea name="experienceEdit[{{ $key }}][answer]" id="answer_input" cols="30" class="form-control summernote_content" rows="6">{{ $questionsData->answer }}</textarea>
                                                    ...
                                                    @if( old('experience') )
                                                        @foreach(old('experience') as $key => $experienceData)
                                                            <div class="row doctor_experience_row mb-4" style="background-color: #f0f1f5d6;">
                                                                ...
                                                                <div class="form-group col-md-12">
                                                                    <label for="company_name_input"> Answer <span class="text-danger">*</span></label>
                                                                    <textarea name="experience[{{ $key }}][answer]" id="answer_input" cols="30" class="form-control summernote_content" rows="6">{{ old("experience.$key.answer") }}</textarea>
...
@push('js')
    ...
    <script>
        ...
        $(document).on('click', '.btn_add_section', function (){
            ...
            let rowCount = $('.blog_section').length +1;
