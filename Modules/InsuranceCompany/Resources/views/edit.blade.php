...
@section('title', "Edit a insurance company ( $form->id )")
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="basic-form">
                            <form class="form" method="POST" enctype="multipart/form-data" action="{{ route('admin.insurance-companies.update', $form->id) }}">
                                @method('PUT')
                                @csrf
                                ...
                                <div class="form-row " style="margin-bottom:  10px">
                                    <div class="form-group col-md-6 @error('image') has-danger @enderror">
                                        ...
                                        <input type="file"
                                               ...
                                               class="dropify"
                                               data-height="200"
                                               data-default-file="{{ $form->insurance_company_image }}"/>
                                                    ...
                                                    <div class="pt-4 row">
                                                        <div class="form-group col-md-12">
                                                            ...
                                                            <input name="{{ $locale }}[title]"
                                                                   value="{{ $form->translate($locale)->title ?? '' }}"
                                                                   class="form-control" />
                                                        ...
                                                        {{--<div class="form-group col-md-12">
                                                            ...
                                                            <textarea name="{{ $locale }}[content]"
                                                                      ...
                                                                      cols="30"
                                                                      class="form-control"
                                                                      rows="10">{{ $form->translate($locale)->content ?? '' }}</textarea>
