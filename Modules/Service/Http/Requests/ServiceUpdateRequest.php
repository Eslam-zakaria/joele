...
class ServiceUpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'en.slug' => ['required_if:language,1,3'],
            'ar.slug' => ['required_if:language,2,3'],
            'en.new_slug' => ['nullable', 'max:255'],
            'ar.new_slug' => ['nullable', 'max:255'],
            ...
            'experienceEdit.*.en.question' => ['required_if:language,1,3', 'max:255'],
            'experienceEdit.*.ar.question' => ['required_if:language,2,3', 'max:255'],
            'experienceEdit.*.en.answer' => ['required_if:language,1,3'],
            'experienceEdit.*.ar.answer' => ['required_if:language,2,3'],
        ];
    }
